      ...
      <div className='z-30 basis-2/5 mt-12 md:mt-32'>
        ...
        >
          ...
          <p className='mt-10 mb-7 text-sm text-center md:text-start'>
            Empowering businesses and individuals by leveraging the latest web
            technologies and crafting beautiful and functional digital
            experiences, one meticulously crafted line of code at a time.
          </p>
        </motion.div>
        {/*CALL TO ACTION*/}
        <motion.div
